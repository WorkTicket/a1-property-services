...
export default function AboutPage() {
  ...
  const localExpertiseDesc = `${yearsInBusinessPhrase()} serving Cedar Falls, Waterloo, and the Cedar Valley. We know Iowa soil, seasons, and what works here.`
        ...
        <div className="section-inner">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <FadeIn direction="right" delay={0.1}>
              ...
              <p className="mt-4 leading-relaxed text-brand-body">
                We have served Cedar Falls, Waterloo, and towns across the Cedar Valley {sinceYearPhrase()}. When you hire us, you are hiring neighbors who care how your yard looks when we drive past it.
              </p>
        ...
        <div className="section-inner">
          <StaggerContainer className="grid gap-8 md:grid-cols-4">
            {[
              ...
              { icon: <Users className="h-6 w-6" />, title: yearsLabel, desc: 'Serving Cedar Falls, Waterloo, and beyond' },
            ].map((item) => (
