...
async function getAllSiteUrls() {
  ...
  const slugs = [
    ...
    "services/preservation-restoration",
    ...
    "services/mulching",
    "services/rock-landscaping",
    "services/tree-planting",
    "services/shrub-installation",
...
async function onRequest2(context2) {
  ...
  const apiKey = context2.env.GOOGLE_PLACES_API_KEY;
  if (!apiKey) {
    return Response.json(staticFallback, { headers: CORS_HEADERS2 });
  }
  try {
    ...
    return Response.json(
      ...
      { headers: { ...CORS_HEADERS2, "Cache-Control": "public, max-age=3600, s-maxage=3600" } }
    );
  } catch {
    return Response.json(staticFallback, { headers: CORS_HEADERS2 });
  }
...
// ../.wrangler/tmp/pages-76u6TZ/functionsRoutes-0.49191668162295643.mjs
var routes = [
  {
